...
(global-set-key (kbd "s-1") (go-to-buffer-running-subprocess "bash" ""))
(global-set-key (kbd "s-2") (go-to-buffer-running-subprocess "bash" "<2>"))
(global-set-key (kbd "s-3") (go-to-buffer-running-subprocess "bash" "<3>"))
(global-set-key (kbd "s-4") (go-to-buffer-running-subprocess "bash" "<4>"))
(global-set-key (kbd "s-5") (go-to-buffer-running-subprocess "bash" "<5>"))
(global-set-key (kbd "s-6") (go-to-buffer-running-subprocess "bash" "<6>"))
(global-set-key (kbd "s-7") (go-to-buffer-running-subprocess "bash" "<7>"))
(global-set-key (kbd "s-8") (go-to-buffer-running-subprocess "bash" "<8>"))
(global-set-key (kbd "s-9") (go-to-buffer-running-subprocess "bash" "<9>"))
