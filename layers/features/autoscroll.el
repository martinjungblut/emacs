(defvar autoscroll-enabled t)

(defun autoscroll-toggle ()
  (interactive)
  (let ((autoscroll-enabled-new-value (not autoscroll-enabled)))
	(setq autoscroll-enabled autoscroll-enabled-new-value)
